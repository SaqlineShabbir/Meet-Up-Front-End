    ...
    return (
      ...
      <Image
       ...
       >
            ...
            <button className='text-center cursor-pointer bg-blue-100 py-3 inline-block text-blue-600 w-60 font-bold rounded-md hover:bg-blue-200 mt-5'> Add friend</button> <br />
